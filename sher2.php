...
font-size:20px;
     ...
     <body style="background-repeat: no-repeat;" background="require.jpg">
         ...
         <div><br>
           ...
           &nbsp;&nbsp;&nbsp; ANSWER: <input name="i1" id="i1" type="text" >  &nbsp;&nbsp;&nbsp; <form method="post" onsubmit="return fun()" ><br> &nbsp;&nbsp;&nbsp; <input type="submit" id="ch" value="Check" formaction="/Sher/sherphp.php" formtarget="first" >
